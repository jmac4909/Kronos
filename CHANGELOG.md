...
- Public product overview, architecture, engineering metrics, and synthetic product renders.
...
- Clarified that the public source is available for evaluation and security review under an all-rights-reserved evaluation license.
