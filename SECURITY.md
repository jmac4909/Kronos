...
- restrict optional Claude lifecycle tracking to correlated `resume|clear` metadata without reading `transcript_path`, terminal input, output, or scrollback, and without emitting stdout context;
