...
| Orchestration boundaries | Work refresh concurrency has one focused coordinator and independent tests for scheduled coalescing, explicit supersession, failure recovery, and disposal. Work/Jira rendering and lifecycle presentation remain in dedicated service/view modules while activation retains command wiring and VS Code notifications. | Pass for Work slice; provider hotspot tracked |
