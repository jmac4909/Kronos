...
<p align="center">
  ...
  <img alt="230 automated local tests" src="https://img.shields.io/badge/test%20suite-230%20local-22C55E">
...
| Automated Node/DOM/board tests | 230 |
| Built-in runtime coverage | 80.71% lines / 72.02% branches / 86.65% functions |
