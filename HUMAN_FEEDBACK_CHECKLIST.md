...
1. From **Kronos Setup**, choose **Choose Folders**, select two safe parent folders in one native dialog, and confirm **Manage Local Projects** opens immediately. Confirm Work does not repeat this discovery button and Projects has one **Manage Local Projects** entry point.
